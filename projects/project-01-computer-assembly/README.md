...
6. **Unbox the case and check the standoffs.**
   ...
   - Find the motherboard screws in the case's screw pack. They have a wide flanged head and a coarse thread, and they are not interchangeable with the fine-thread screws used for the PSU and drives. Count out nine before you start.
